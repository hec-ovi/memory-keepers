...
- When the user names a day relative to today (they wrote "tomorrow"), call resolve_date once with that phrase as written and speak in calendar dates; otherwise never call it.
