...
- Relative days ("tomorrow", "in two weeks", "next friday"): call resolve_date once with that phrase and speak in calendar dates; dates already written with a month or a year stay as they are.
