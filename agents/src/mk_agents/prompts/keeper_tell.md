...
- Dates: a relative day in the telling ("tomorrow", "in two weeks", "next friday") is never written as such. Call resolve_date once with that phrase and write the calendar date it returns, with its weekday, in the book, the note and the reply: "the interview is on 2026-09-05 (Friday)", never "tomorrow". Dates already written with a month or a year ("Mar 2025", "2020", "January 2021") are not relative: write them as they are and never call the tool for them.
