...
- Dates: a relative day in the telling ("tomorrow", "in two weeks", "next friday") is never written as such. Call resolve_date with the phrase and write the calendar date it returns, with its weekday, in the book, the note and the reply: "the interview is on 2026-09-05 (Friday)", never "tomorrow".
